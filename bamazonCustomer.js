    ...
    connection.query("SELECT * FROM products", function(err, res) {
      ...
      inquirer.prompt({
        ...
        if(answer.stock < res[stockIndex].stock_quantity){ 
          ...
          // Then shows the price for that item in the console.
          console.log("Updated Stock: " + updatedStock);
          } 
          console.log("Price: " + res[stockIndex].price);     
        } 
        else { 
...
// "UPDATE products SET stock_quantity[stockIndex] = stock_quantity - answer.stock WHERE item_id = stockIndex"
